...
const Footer = () => {
    return (
        <>
            <div className="w-full md:flex text-neutral-500 md:justify-between md:items-center bottom-0  md:relative">
                <Link href="https://www.github.com/syedfaizan8/velocitype.git" target="_blank" rel="noopener noreferrer">
                    <div
                        className="flex space-x-1 hover:text-neutral-200 cursor-pointer">
                ...
                <div className="md:space-x-4 md:flex ">
                    <Link href="https://www.syedfaizan.in" target="_blank" rel="noopener noreferrer">
                        <div className="flex md:space-x-1 space-x-1 hover:text-neutral-200 cursor-pointer">
