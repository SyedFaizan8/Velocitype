...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        await prisma.$transaction([
            ...
            prisma.totalStatistics.updateMany({ where: { user_id }, data: { total_letters_typed: 0, total_tests_taken: 0, total_words_typed: 0, total_time_typing: 0 } }),
        ...
        return NextResponse.json(error instanceof ApiError
            ? error : new ApiError(500, "Something went wrong while reseting account"))
    }
}
