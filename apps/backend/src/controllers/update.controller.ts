...
const updateUserField = async (user_id: string, field: object, select: object) => {
...
export const updateFullname = asyncHandler(async (req, res) => {
    ...
    const updatedFullname = await updateUserField(user_id, { fullname: newFullname }, { fullname: true });

    return res.status(200).json(new ApiResponse(200, updatedFullname, "Fullname updated successfully"));
});
...
export const updateUsername = asyncHandler(async (req, res) => {
    ...
    const updatedUsername = await updateUserField(user_id, { username: newUsername }, { username: true });

    return res.status(200).json(new ApiResponse(200, updatedUsername, "Username updated successfully"));
});
...
export const updateEmail = asyncHandler(async (req, res) => {
    ...
    const updatedEmail = await updateUserField(user_id, { email: newEmail }, { email: true });

    return res.status(200).json(new ApiResponse(200, updatedEmail, "Email updated successfully"));
});
...
export const updateBio = asyncHandler(async (req, res) => {
    ...
    const updatedBio = await updateUserField(user_id, { bio: newBio }, { bio: true });
...
export const updateTwitter = asyncHandler(async (req, res) => {
    ...
    const updatedTwitter = await updateUserField(user_id, { twitter }, { twitter: true });

    return res.status(200).json(new ApiResponse(200, updatedTwitter, "Twitter updated successfully"));
});
...
export const updateInstagram = asyncHandler(async (req, res) => {
    ...
    const updatedInstagram = await updateUserField(user_id, { instagram }, { instagram: true });

    return res.status(200).json(new ApiResponse(200, updatedInstagram, "Instagram updated successfully"));
});
...
export const updateWebsite = asyncHandler(async (req, res) => {
    ...
    const updatedWebsite = await updateUserField(user_id, { website }, { website: true });

    return res.status(200).json(new ApiResponse(200, updatedWebsite, "Website updated successfully"));
});

// update this later
export const updateDp = asyncHandler(
    async (req, res) => {
        const user_id = getUserId(req);
    ...
    try {
        ...
        await prisma.$transaction([
            ...
            prisma.totalStatistics.update({
                where: { user_id },
                data: { total_letters_typed: 0, total_tests_taken: 0, total_words_typed: 0 },
            }),
