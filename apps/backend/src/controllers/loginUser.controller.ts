...
import { comparePassword, generateAccessAndRefereshTokens } from "@/utils/userAuth";
...
const loginUser = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (!validationResult.success) return new ApiError(400, "email and password must be required");
